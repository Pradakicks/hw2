...
test: test.cpp util.o book.o product.o clothing.o movie.o mydatastore.o
	$(CXX) $(CXXFLAGS) -o $@ util.o book.o test.cpp product.o clothing.o movie.o mydatastore.o
